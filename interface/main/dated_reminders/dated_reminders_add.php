    ...
    <form id="addDR" style="margin-left:40px;" id="newMessage" method="post" onsubmit="return top.restoreSession()">
     ...
     <?php echo xlt('Send to') ?> :  <p style="line-height:1.8em;">
      ...
      <?php echo xlt('Priority') ?> :    
                 <input <?php echo ($this_message['message_priority'] == 3 ? 'checked="checked"' : '') ?> type="radio" id="priority" name="priority" value='3'> <?php echo xlt('Low') ?> 
                 <input <?php echo ($this_message['message_priority'] == 2 ? 'checked="checked"' : '') ?>type="radio" name="priority" id="priority"  value='2'> <?php echo xlt('Medium') ?>  
                 <input <?php echo ($this_message['message_priority'] == 1 ? 'checked="checked"' : '') ?>type="radio" name="priority" id="priority"  value='1'> <?php echo xlt('High') ?>
      <br />         
      <br />
