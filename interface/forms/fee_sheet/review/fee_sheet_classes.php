...
class code_info
{
    function __construct($c,$ct,$desc,$selected=true)
    {
        ...
        if (check_code_set_filters($c,array("active","problem"))) $this->allowed_to_create_problem_from_diagnosis="TRUE";
        ...
        if (check_code_set_filters($c,array("active","diag"))) $this->allowed_to_create_diagnosis_from_problem="TRUE";
    }
    public $code;    
    public $code_type;
    public $description;
