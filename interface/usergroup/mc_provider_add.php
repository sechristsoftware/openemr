...
if (isset($_POST["mode"]) && $_POST["mode"] == "provider_number") {
  	echo '
...
<table>
	<tr>
		<td>
			<span class="title"><?php xl('Add Provider Number','e'); ?></span>&nbsp;&nbsp;&nbsp;</td>
...
<table border=0 cellpadding=0 cellspacing=0 style="width:450px;">
	<tr>
		...
		<td>
			<select style="width:150px;" name=pid>
				<?php
				$fres = sqlStatement("select * from users order by username");
				if ($fres) {
	...
	<tr>
		...
		<td  style="width:150px;">
			<input type=entry name=provider_number style="width:150px;">
		</td>
	</tr>
