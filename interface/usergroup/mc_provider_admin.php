...
<table>
    <tr>
        <td>
        <span class="title"><?php xl('Edit Provider Number','e'); ?></span>&nbsp;&nbsp;&nbsp;</td><td>
...
<form name='medicare' method='post' action="mc_provider.php" target="_parent">
    <input type=hidden name=mode value="provider_number">
    <input type=hidden name=newmode value="admin_medicare">	<!--	Diffrentiate Admin and add post backs -->
    <input type=hidden name=mid value="<?php echo $my_id;?>">
    <?php $iter = sqlQuery("select * from mc_provider_numbers where id='$my_id'"); ?>
...
<tr>
	...
	<td>
		<select name=pid style="width:150px;" >
			<?php
			$fres = sqlStatement("select * from users WHERE authorized = 1 order by username");
			if ($fres) {
...
<tr>
	<td style="width:180px;">
		<span class=text><?php xl('Provider Number','e'); ?>: </span>
	</td>
	<td style="width:270px;">
		<input type=entry name=provider_number  style="width:150px;" value="<?php echo $iter["provider_number"]; ?>">
	</td>
</tr>
